...
function gen_blogposts_cache() {
	...
	while ($blog=mysql_fetch_assoc($res)) {
		...
		$blog['post_content']=sanitize_and_format($blog['post_content'],TYPE_STRING,$GLOBALS['__html2format'][TEXT_DB2DISPLAY]);
