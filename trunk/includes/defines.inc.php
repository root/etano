...
define('_BASEURL_','http://dating.sco.ro/etano_fields');// protocol required (http:// )
define('_BASEPATH_','/www/htdocs/etano_fields');// path on server to your site
...
define('_LICENSE_KEY_','3760A86F579507111DFF6B'); // md5()=
define('_INTERNAL_VERSION_','1.07');
