<?php
$_pfields[1]['label']=$_lang[3];
$_pfields[1]['html_type']=2;
$_pfields[1]['editable']=true;
$_pfields[1]['visible']=true;
$_pfields[1]['dbfield']='f1';
$_pfields[1]['fk_pcat_id']=1;
$_pfields[1]['help_text']=$_lang[5];

$_pfields[2]['label']=$_lang[8];
$_pfields[2]['html_type']=3;
$_pfields[2]['searchable']=true;
$_pfields[2]['search_type']=10;
$_pfields[2]['search_label']=$_lang[9];
$_pfields[2]['reg_page']=1;
$_pfields[2]['required']=true;
$_pfields[2]['editable']=true;
$_pfields[2]['visible']=true;
$_pfields[2]['dbfield']='f2';
$_pfields[2]['fk_pcat_id']=1;
$_pfields[2]['accepted_values']=array('-',$_lang[6],$_lang[7]);
$_pfields[2]['default_value']=array('1');
$_pfields[2]['default_search']=array('2');
$_pfields[2]['help_text']=$_lang[10];

$_pfields[3]['label']=$_lang[13];
$_pfields[3]['html_type']=10;
$_pfields[3]['searchable']=true;
$_pfields[3]['search_type']=10;
$_pfields[3]['search_label']=$_lang[14];
$_pfields[3]['reg_page']=1;
$_pfields[3]['required']=true;
$_pfields[3]['editable']=true;
$_pfields[3]['visible']=true;
$_pfields[3]['dbfield']='f3';
$_pfields[3]['fk_pcat_id']=1;
$_pfields[3]['accepted_values']=array('-',$_lang[11],$_lang[12]);
$_pfields[3]['default_value']=array('2');
$_pfields[3]['default_search']=array('1');
$_pfields[3]['help_text']=$_lang[15];
