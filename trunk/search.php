...
// should not return any result or at least warn the member that the zip code was not found.
	...
	$query="SELECT $select FROM $from WHERE $where ORDER BY a.`score` DESC";
