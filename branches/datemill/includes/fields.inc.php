...
$GLOBALS['_pfields'][2]['label']=$GLOBALS['_lang'][201];
...
$GLOBALS['_pfields'][2]['help_text']=$GLOBALS['_lang'][203];

$GLOBALS['_pfields'][3]['label']=$GLOBALS['_lang'][204];
...
$GLOBALS['_pfields'][3]['help_text']=$GLOBALS['_lang'][206];

$GLOBALS['_pfields'][4]['label']=$GLOBALS['_lang'][207];
...
$GLOBALS['_pfields'][4]['help_text']=$GLOBALS['_lang'][209];

$GLOBALS['_pfields'][5]['label']=$GLOBALS['_lang'][210];
...
$GLOBALS['_pfields'][5]['help_text']=$GLOBALS['_lang'][212];

$GLOBALS['_pfields'][6]['label']=$GLOBALS['_lang'][213];
$GLOBALS['_pfields'][6]['field_type']=FIELD_LOCATION;
...
$GLOBALS['_pfields'][6]['default_value']=array('218');
$GLOBALS['_pfields'][6]['default_search']=array();
$GLOBALS['_pfields'][6]['help_text']=$GLOBALS['_lang'][215];

$GLOBALS['_pfields'][7]['label']=$GLOBALS['_lang'][216];
...
$GLOBALS['_pfields'][7]['help_text']=$GLOBALS['_lang'][218];

$GLOBALS['_pfields'][8]['label']=$GLOBALS['_lang'][219];
$GLOBALS['_pfields'][8]['field_type']=FIELD_TEXTFIELD;
...
$GLOBALS['_pfields'][8]['help_text']=$GLOBALS['_lang'][221];
...
$GLOBALS['_pfields'][9]['help_text']=$GLOBALS['_lang'][224];


$GLOBALS['_pcats'][1]['pcat_name']=$GLOBALS['_lang'][1];
$GLOBALS['_pcats'][1]['access_level']=7;
$GLOBALS['_pcats'][1]['fields']=array(1,2,3,4,5,6,7,8,9);
