...
class XMLText_dsb {
	...
	function XMLText_dsb() {

		// Init property
		$this->nodeValue = null;
		$this->nodeType = XML_TYPE_TEXT;

	} // End XMLText_dsb-constructor

} // End XMLText_dsb class


// XML sub-class: Tags =====================================================
class XMLNode_dsb extends XMLText_dsb {
	...
	// XMLNode_dsb constructor --------------------------------------------------
	function XMLNode_dsb() {
	...
	function createTextNode($value) {
		$tmp = new XMLText_dsb();
// changed by Dan Caragea. We need the real value, not trimmed.
...
} // End XMLNode_dsb class


// Main XML class ==========================================================
class XML_dsb extends XMLNode_dsb {
