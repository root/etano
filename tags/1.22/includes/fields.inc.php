...
require_once _BASEPATH_.'/includes/classes/fields/01field_textfield.class.php';
require_once _BASEPATH_.'/includes/classes/fields/02field_textarea.class.php';
require_once _BASEPATH_.'/includes/classes/fields/03field_select.class.php';
require_once _BASEPATH_.'/includes/classes/fields/04field_mchecks.class.php';
require_once _BASEPATH_.'/includes/classes/fields/05field_range.class.php';
require_once _BASEPATH_.'/includes/classes/fields/06field_birthdate.class.php';
require_once _BASEPATH_.'/includes/classes/fields/07field_age_range.class.php';
require_once _BASEPATH_.'/includes/classes/fields/08field_location.class.php';
require_once _BASEPATH_.'/includes/classes/fields/09field_zip_distance.class.php';
...
$GLOBALS['_pfields'][3]=new field_birthdate(
								array('label'=>&$GLOBALS['_lang'][2290],
									...
									'accepted_values'=>array('min'=>19,'max'=>78),
