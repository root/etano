...
newdsb
===============================================================================
File:                       ajax/get_profile_comment.php
$Revision: 93 $
...
$output='';
if (isset($_SESSION['user']['user_id']) && isset($_POST['comment_id']) && !empty($_POST['comment_id'])) {
	$comment_id=(int)$_POST['comment_id'];
	$query="SELECT `comment_id`,`comment` FROM `{$dbtable_prefix}profile_comments` WHERE `comment_id`='$comment_id' AND `fk_user_id`='".$_SESSION['user']['user_id']."'";
